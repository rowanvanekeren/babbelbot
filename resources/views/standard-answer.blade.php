    ...
    <div class="container-fluid" ng-controller="standardIntentController" {{--ng-init="getUserApps()"--}} ng-cloak>
        ...
        <div class="row" ng-cloak>
            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="col-md-12 app-wrapper standard-intent" ng-repeat="intent in intents">
                     ...
                     <div class="answers" ng-class="{'answers-open' : answersToggle == intent.id}">
                         <div class="form-group" ng-repeat="answer in intent.intent_answers" >
                             ...
                             <div class="input-wrapper deletable-input intent-answer-input">
                                 <i class="fa fa-trash-o input-trash-icon" aria-hidden="true" ng-click="deleteAnswer($index, answer, intent)"></i>
                                 <input id="inp-access-token" class="default-input inp-loading" type="text"
                                        my-enter="saveAnswer($element, intent, answer)"   placeholder="Geef antwoord in"
