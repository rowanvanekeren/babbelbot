...
@section('content')
    <div class="container-fluid" ng-controller="appController" ng-init="getUserApps()">
        <div class="row modal-overlay" ng-show="showCreateApp"></div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 app-wrapper new-app" ng-show="showCreateApp" ng-class="{'ng-enter ng-enter-active': showCreateApp}">
                <form id="newApp" name="newApp">
                <div class="app-top-section">
                    <div class="input-wrapper disable-shrink">
                        <input type="text" class='inp-head-name' placeholder="App naam" name="title" ng-model="title">
                    </div>
                    <span ng-click="newAppTrigger(newApp)"><i class="fa fa-times " aria-hidden="true"></i></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper see-password-input disable-shrink">
                            ...
                            <input id="inp-access-token" class="default-input inp-loading" type="password" name="access_token" ng-model="access_token">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper see-password-input disable-shrink">
                            <i class="fa fa-eye password-eye-icon" aria-hidden="true"></i>
                            <input id="inp-dev-token" class="default-input " type="password" name="server_token"  ng-model="server_token">
            ...
            <div class="col-md-6 col-md-offset-3">
                   ...
                   <div class="col-md-12 app-wrapper" ng-repeat="app in apps">
                    <div class="app-top-section">
                        <div class="input-wrapper disable-shrink">
                            <input type="text" class='inp-head-name' ng-model="app.title">
                    ...
                    <div class="app-center-section">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper see-password-input">
                                <i class="fa fa-eye password-eye-icon" aria-hidden="true"></i>
                                <input id="inp-access-token" class="default-input inp-loading" type="password" ng-model="app.access_token">
                                <i class="fa fa-repeat input-saving-overlay hidden"></i>
                            </div>
                            <div class="input-error">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper see-password-input">
                                <i class="fa fa-eye password-eye-icon" aria-hidden="true"></i>
                                <input id="inp-dev-token" class="default-input " type="password">
                                <i class="fa fa-repeat input-saving-overlay hidden"></i>
                            </div>
                        </div>
                    </div>
